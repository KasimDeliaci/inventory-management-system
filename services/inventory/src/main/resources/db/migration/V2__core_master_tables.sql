...
CREATE TABLE suppliers (
  ...
  email             VARCHAR(100) NOT NULL,  -- Business emails must be unique among non-deleted rows
...
-- Email must be unique among non-deleted suppliers
CREATE UNIQUE INDEX uq_suppliers_email_active ON suppliers (email) WHERE deleted_at IS NULL;
...
CREATE TABLE customers (
  ...
  email             VARCHAR(100) NOT NULL,  -- Customer emails must be unique among non-deleted rows
  phone             VARCHAR(30)  NOT NULL,
  city              VARCHAR(50)  NOT NULL,
  created_at        timestamptz NOT NULL DEFAULT now(),
  updated_at        timestamptz NOT NULL DEFAULT now(),
...
-- Email must be unique among non-deleted customers
